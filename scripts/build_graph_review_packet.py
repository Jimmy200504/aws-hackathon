...
def main() -> None:
    ...
    parser.add_argument("--graph-manifest", type=Path, default=Path("artifacts/skill-graph-full/release/runs/deterministic-v2-rules-v3-full/evaluation-cutoff/manifest.json"))
    parser.add_argument("--output", type=Path, default=Path("artifacts/skill-graph-review/deterministic-v2-rules-v3-full"))
